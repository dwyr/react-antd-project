...
class SiderNav extends React.Component {
  render() {
    ...
    return (
      <div style={{'position':'relative',height: '100vh',overflowY:'scroll', 'paddingTOP':'70px'}}>
        <div style={{
          textAlign:'center',
          fontSize: '22px',
          color: '#fff',
          ...
          <span className={this.props.collapsed?'':'hidden'} style={{marginLeft:'10px',verticalAlign: 'middle'}}>新临建</span></div>
